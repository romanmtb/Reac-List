      ...
      .then(res => {
        ...
        this.setState({
          news: data.results.map(i => {
            i.opened = false;
            return i;
          }), loading: false, totalPages: data.pages
        })
      })
      ...
      <div className="container">
        ...
        return (
            ...
            <div className="container">
                <header className="jumbotron">
                    <GuardianHeader/>
                    {!this.state.loading ? <HeaderMenuComponent refreshNews={this.refreshNews}/> : <div>
                        <HeaderMenuComponent refreshNews={this.refreshNews}/> <LoadingComponent />
                    </div> }
                </header>
